...
class periodicSalesReports(models.TransientModel):
    ...
    start_date = fields.Date(required=True, string="Start Date", default=lambda self: fields.Date.today())
    end_date = fields.Date(required=True, string="End Date", default=lambda self: fields.Date.today())
