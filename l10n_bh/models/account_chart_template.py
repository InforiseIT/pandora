...
class AccountChartTemplate(models.Model):
    ...
    def _prepare_all_journals(self, acc_template_ref, company, journals_dict=None):
        ...
        if self == self.env.ref('l10n_bh.bh_chart_template_standard'):
    ...
    def _load_template(self, company, code_digits=None, account_ref=None, taxes_ref=None):
        ...
        if self == self.env.ref('l10n_bh.bh_chart_template_standard'):
            ...
            if ifrs_journal:
                ifrs_account_ids = [self.env.ref('l10n_bh.bh_account_100101').id,
                                    self.env.ref('l10n_bh.bh_account_100102').id,
                                    self.env.ref('l10n_bh.bh_account_400070').id]
            ...
            self.env.ref('l10n_bh.bh_tax_group_10').write(
                {'property_tax_payable_account_id': account_ref.get(self.env.ref('l10n_bh.bh_account_202003').id),
                 'property_tax_receivable_account_id': account_ref.get(self.env.ref('l10n_bh.bh_account_100103').id)})
